...
-- Config.notif = "ox_lib" -- ox_lib or core  - option ox_lib or esx Core
...
Config.StartPedCoords = vector4(-1041.45, -2730.21, 13.80-1.0, 205.61) -- the ped you target coords  -1043.4436, -2737.9719, 20.1693, 204.1283

Config.CarSpawn = vector4(-1090.7405, -2683.4019, 13.4173, 268.6733) -- this is where the car spawns for the cinematic camera

Config.CarDriveTo = vector3(-1036.38, -2718.46, 13.77) -- where the car drives to pick the player up

Config.TourPoints = {     --  need to add locations - locksmith - 
    {
        coords = vector3(-66.62, -1763.11, 29.25), -- coords the ped drives to
        title = "Gas Stations",
